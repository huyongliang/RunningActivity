package firework.hyl.running.common.util.ip;
...
public class IPSeeker {
	...
	private IPSeeker() {
		...
		try {
			...
			// ipFile = new
			// RandomAccessFile("D:/Program Files/Tomcat 5.0/webapps/RunCommunity/WEB-INF/classes/com/briup/run/common/util/ip/ip.dat",
			// "r");
