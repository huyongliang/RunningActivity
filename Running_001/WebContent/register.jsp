							...
							<TR>
								<TD width="100%">
									<FORM onSubmit="return validateRegisterForm(this);"
										action="member/member-register.action" method="post">
										<TABLE width="100%">
											<thead>
												<TR>
													<TH colSpan=3><font
											...
											<TBODY>
												...
												<TR>
													...
													<TD><INPUT type=password maxLength=14
														style="width: 200px" name=passwd></TD>
												...
												<TR>
													...
													<TD><INPUT type=password maxLength=14
														style="width: 200px" name=passwdre /></TD>
												...
												<TR>
													...
													<TH><IMG alt=authCode src="getCheckCode" /></TH>
												</TR>
												<tfoot>
													<TR>
														<TD colSpan=3>
