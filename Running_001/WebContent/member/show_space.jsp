				...
				<div id="center">
					...
					<form action="result_Flow.htm" method="post" name="form1">
						<table width="600">
							<thead>
								<tr>
									<th><h4>【${friend.nickName}】的空间</h4></th>
								</tr>
							</thead>
							<tr>
								<td width="100%">
										...
										<tbody>
											<tr>
												<td rowspan="5" width="30%" class="line4"><img
													src="GetImgServlet?imgPath=${friend.memberSpace.icon}"
													alt=Face width="84" height="84"></td>
												<th width="25%" class="line1">用户名</th>
												<td width="45%">${nickName}</td>
											</tr>
											...
											<tr>
												...
												<td>${friend.graderecord.gradename}</td>
											</tr>
											<tr>
												<th class="line1">来自</th>
												<td>${friend.getCityString()}</td>
											</tr>
											<tr>
												<th class="line1">跑步习惯与主张</th>
												<td colspan="2" height="90"><span>&nbsp;&nbsp;&nbsp;
														${friend.memberSpace.opinion} </span></td>
											</tr>
										</tbody>
