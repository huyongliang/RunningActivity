							...
							<TBODY align="left">
								<TR>
									<TD style="PADDING-TOP: 0px" vAlign=top align="middle" width=24
										rowSpan=3><IMG src="images/icon03.gif" width="16"
										height=16></TD>
								...
								<TR>
									<TD class=fontgray style="PADDING-TOP: 2px" colSpan=2>
										<OL>
											...
											<LI><FONT color=#ff0000>密码提示问题和答案完全正确，方可找回密码</FONT></LI>
										</OL>
									</TD>
								</TR>
							</TBODY>
						</TABLE>
						<FORM onSubmit="return checkGetPasswdForm(this);"
							action="member/member-backPWD.action" method=post>
							<TABLE width="100%" align=center border=0>
								<!--DWLayoutTable-->
								<TBODY>
									<TR>
										<TD align=right width="40%">用户名：</TD>
										<TD align=left width="60%"><INPUT class=input1
											name=userName /></TD>
									</TR>
									<TR>
										<TD align=right width="40%">密码提示问题：</TD>
										<TD align=left width="60%"><INPUT class=input1
											name=passwdQuestion /></TD>
									</TR>
									<TR>
										<TD align=right width="40%">密码提示答案：</TD>
										<TD align=left width="60%"><INPUT class=input1
											name=passwdAnswer /></TD>
									</TR>
									<TR>
										<TD colSpan=2>
											<DIV align=center>
									...
									<s:if test="isok.equals(\"OK\")">
										<tr>
											<td align=right width="40%">你的密码是：</td>
											<td align=left width="60%">${ret}</td>
										</tr>
									</s:if>
									<s:elseif test="isok.equals(\"NO\")">
										<tr>
